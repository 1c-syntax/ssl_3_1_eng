...
//   * Subject - String - Template subject (for emails).
...
//   * Ref - Undefined - Reference to a catalog item.
...
//   * AttachmentsFormats - ValueList - Format in which the print forms are saved.
...
//                                   
//   * PackToArchive - Boolean - Attach print forms as an archive.
//                                
//   * EmailFormat1 - EnumRef.EmailEditingMethods - Type of email text: HTML or NormalText.
...
//   * TemplateType - String - "MailMessage" or "SMS".
//
Function TemplateParametersDetails() Export
	...
	Result.Insert("ExportTemplates",                  New Map);
	Result.Insert("PrintCommands",                   New Array);
	Result.Insert("ExportCommands",                 New Array);
...
Function SendOptionsConstructor(Template, SubjectOf, UUID) Export
	...
	SendOptions.AdditionalParameters.Insert("ExportTemplates", New Array);
