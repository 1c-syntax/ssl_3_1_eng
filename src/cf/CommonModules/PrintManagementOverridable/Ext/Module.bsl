...
// Generates a table with object's common fields.
// 
// Parameters:
...
//  TableOfCommonFields - ValueTable:
...
//      
//      NewRow = CommonFieldsTable.Add();
//      NewRow.ID = "ManagementAccCurr";
//      NewRow.Presentation = NStr("en = 'Currency (management accounting)'");
//      NewRow.Value = Constants.ManagementAccountingCurrency.Get();
//      
//      NewRow = CommonFieldsTable.Add();
//      NewRow.ID = "ManagementAccCurr";
//      NewRow.Presentation = NStr("en = 'Currency (regulated accounting)'");
//      NewRow.Value = Constants.LocalAccountingCurrency.Get();
//      
//  EndIf;
//
Procedure WhenFillingInListOfCommonFields(TypeOfPrintingObject, TableOfCommonFields) Export
