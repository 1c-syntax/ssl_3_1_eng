...
//  ErrorText - String
//
Procedure RegisterUndeliveredServerNotificationsRetrievalError(Val ErrorText) Export
	
	WriteLogEvent(
		NStr("en = 'Server notifications.Error getting or processing undelivered server notifications'",
