...
Procedure OpenTheRegionalSettingsForm(CallbackDescription = Undefined, Parameters = Undefined) Export
	
	OpenForm("CommonForm.RegionalSettings", Parameters, , , , , CallbackDescription);
