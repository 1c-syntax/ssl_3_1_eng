...
Procedure ShowAllVisibleAttributesUnlockedWarning(ContinuationHandler = Undefined) Export
	...
	ShowMessageBox(ContinuationHandler,
		NStr("en = 'Редактирование всех видимых реквизитов объекта уже разрешено.';"));
...
Procedure CheckObjectRefs(Val ContinuationHandler, Val ReferencesArrray, Val AttributesSynonyms) Export
	...
	DialogTitle = NStr("en = 'Разрешение редактирования реквизитов';");
	...
	If AttributesSynonyms.Count() > 1 Then
		QueryText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("en = 'Для того чтобы не допустить рассогласования данных в приложении,
	...
	Buttons.Add(DialogReturnCode.Yes, NStr("en = 'Проверить и разрешить';"));
