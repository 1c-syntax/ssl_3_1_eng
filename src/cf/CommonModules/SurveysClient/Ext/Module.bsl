...
Procedure StartInterview(Respondent, QuestionnaireTemplate = Undefined) Export
	...
	If QuestionnaireTemplate = Undefined Then
		...
		CallbackDescription = New CallbackDescription("StartInterviewWithTemplateChoiceCompletion", ThisObject, Respondent);

		ShowInputValue(CallbackDescription, Undefined, , Type("CatalogRef.QuestionnaireTemplates"));
