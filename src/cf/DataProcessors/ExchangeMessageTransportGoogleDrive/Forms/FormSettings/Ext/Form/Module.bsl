...
Procedure GetToken(Command)
	...
	OpenForm("DataProcessor.ExchangeMessageTransportGoogleDrive.Form.TokenReceiptForm",
...
Function CreateRequestToUseExternalResources(Val Object)
	...
	Permissions.Add(ModuleSafeModeManager.PermissionToUseInternetResource("HTTPS", "www.googleapis.com"));
