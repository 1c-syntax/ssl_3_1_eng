...
Function GenerateScriptFiles() 
	...
	ScriptParameters.COMConnectorName = ClientRunParameters.COMConnectorName;
	ScriptParameters.IsBaseConfigurationVersion = ClientRunParameters.IsBaseConfigurationVersion;
