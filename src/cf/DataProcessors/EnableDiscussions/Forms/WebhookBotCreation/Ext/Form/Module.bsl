...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	ConversationsLocalization.OnFillInstructionOnIntegrationConnect(Items.Instruction.Title, 
		ConversationsInternalClientServer.ExternalSystemsTypes().Webhook);
...
Procedure ActivateServer()
	...
	IntegrationParameters.Type = ConversationsInternalClientServer.ExternalSystemsTypes().Webhook;
