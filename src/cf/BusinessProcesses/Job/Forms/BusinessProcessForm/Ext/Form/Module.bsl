...
Procedure NotificationProcessing(EventName, Parameter, Source)
	...
	If EventName = "DeferredStartSettingsChanged" Then
		Defer = (Parameter.Defer And Parameter.State = PredefinedValue("Enum.ProcessesStatesForStart.ReadyToStart"));
...
Function JobStatusMessage(Form)
	...
	If Form.Object.Completed Then
		...
		TextString = ?(Form.Object.Completed2, 
			NStr("en = 'The duty is completed on %1.';"), 
			NStr("en = 'The duty is canceled on %1.';"));
	...
	ElsIf Form.Defer Then
		...
		StateText = StringFunctionsClientServer.SubstituteParametersToString(NStr("en = 'The duty will be started on <a href=""%1"">%2</a>';"),
				"OpenDeferredStartSetup", DeferredStartDateAsString);
	EndIf;
