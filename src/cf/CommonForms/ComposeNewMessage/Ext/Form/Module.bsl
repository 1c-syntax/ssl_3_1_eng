...
Procedure AttachmentFormatClick(Item, StandardProcessing)
	...
	CallbackDescription = New CallbackDescription("AfterAttachmentsFormatSelected", ThisObject);
	CommonClient.ShowAttachmentsFormatSelection(CallbackDescription, SelectedFormatSettings());
EndProcedure
